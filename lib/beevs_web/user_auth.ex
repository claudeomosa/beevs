defmodule BeevsWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      BeevsWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule BeevsWeb.PageLive do
        use BeevsWeb, :live_view

        on_mount {BeevsWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{BeevsWeb.UserAuth, :ensure_authenticated}] do
  ...
  defp signed_in_path(_conn), do: ~p"/projects"
end

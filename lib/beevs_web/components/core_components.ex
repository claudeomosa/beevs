defmodule BeevsWeb.CoreComponents do
  @moduledoc """
    ...
    <div class="overflow-y-auto px-4 sm:overflow-visible sm:px-0">
      <table class="mt-11 w-[40rem] sm:w-full">
        <thead class="text-left text-[0.8125rem] leading-6 text-zinc-500">
          <tr>
            <th :for={col <- @col} class={["p-0 pb-4 pr-6 font-normal text-[1rem] font-mono", @class]}>
              <%= col[:label] %>
            </th>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BeevsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BeevsWeb.Gettext, "errors", msg, opts)
    end
  end

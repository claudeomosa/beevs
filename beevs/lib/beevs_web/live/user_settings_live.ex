defmodule BeevsWeb.UserSettingsLive do
  ...
  def render(assigns) do
    ~H"""
    <section class="sm:px-20">
      <.header class="text-center">
        <span class="text-4xl">Account Settings</span>
      </.header>

      <div class="sm:flex justify-between items-center px-6">
      ...
      <div class="sm:space-x-12 sm:flex sm:justify-evenly">
        <div class="w-full">
          <.simple_form
            for={@username_form}
            id="username_form"
